...
import famousAmosAvatar from 'static/images/avatars/famous-amos@3x.jpg?resize&sizes[]=48&sizes[]=96&sizes[]=144'
...
<Grid>
  ...
  <Card>
    <Card.Avatar src={famousAmosAvatar.src} srcSet={famousAmosAvatar.srcSet} />
...
<ProgressBar value={3500} maxValue={3500} label="Illustrations" description={`${Math.round((3500 / 3500) * 100)}% funded`}/>
...
<ProgressBar value={250} maxValue={10000} label="Community Proposal Fund" description={`${Math.round((250 / 10000) * 100)}% funded`}/>

## Community Fund

With the Community Fund we can fund our own marketing efforts and all other avenues we as a community would like to pursue. The “Community Proposal Fund” will be used to obtain donations directly from the community. 
...
<Table aria-label="Multi-sign wallets">
  ...
  <Table.Body>
    <Table.Row>
      <Table.Cell>Famous Amos</Table.Cell>
      <Table.Cell>
        <MultiSigner
          Avatar={
            <Avatar
